...
export function PracticeHeader({ user, onLogout }: PracticeHeaderProps) {
  return (
    <header className="topbar">
      ...
      <div className="topbar__profile">
        ...
        <div className="practice-topbar__coins">
          ...
          <span className="practice-topbar__coin-value">1,250</span>
        </div>
        <span aria-hidden="true" className="material-symbols-outlined topbar__star">
          star
        </span>
        <div className="topbar__avatar">
          <img alt="Junior Coder Avatar" src={DEFAULT_AVATAR} />
        </div>
